...
import { setIsDarkMode, setIsSidebbarCollapsed } from "@/state";
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="relative">
          <input
            ...
            className="pl-10 pr-4 py-2 w-50 md:w-64 border-2 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500"
          />
